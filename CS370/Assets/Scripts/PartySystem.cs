...
public class PartySystem : MonoBehaviour{
    ...
    void Start(){
        if (PlayerParty == null || PlayerParty.Count == 0){
            ...
            PlayerParty.Add(new Unit(Unit.PartyClass.Empty, "Empty", Unit.UnitClass.Empty, 0, 0, 0, 0, 0, 0, 0, new string[] { "", "", "" }));
            ...
            PlayerParty.Add(new Unit(Unit.PartyClass.Player, "Steve", Unit.UnitClass.Mage, 10, 100, 100, 20, 5, 10, 50, new string[] { "Fireball", "Ice Spike", "Lightning Bolt" }));
            PlayerParty.Add(new Unit(Unit.PartyClass.Empty, "Empty", Unit.UnitClass.Empty, 0, 0, 0, 0, 0, 0, 0, new string[] { "", "", "" })); 
        ...
        if (StoredParty == null || StoredParty.Count == 0)
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                StoredParty.Add(new Unit(Unit.PartyClass.Empty, "Empty", Unit.UnitClass.Empty, 0, 0, 0, 0, 0, 0, 0, new string[] { "", "", "" }));
            }
        }
    }
